...
class RegistrationController extends Controller
{
    public function registerAction()
    {
        ...
        $this->container->get('session')->getFlashBag()->set('error', 'Pour bénéficier de nos services en ligne. vous devez posséder un compte particulier-coach.com');
        ...
        if ($process) {
            ...
            if ($confirmationEnabled) {
                ...
                $route = 'coach_user_registration_check_email';
            } else {
                $authUser = true;
                $route = 'coach_user_registration_confirmed';
                //// serach if the email exist in ContactPerson
                $contactPerson = $this->addContactPerson($user);
    ...
    **/
    ...
    public function confirmAction($token)
    {
        ...
        $response = new RedirectResponse($this->container->get('router')->generate('coach_user_registration_confirmed'));
        $this->authenticateUser($user, $response);
    ...
    public function confirmedAction()
    {
        ...
        return $this->container->get('templating')->renderResponse('ApplicationSonataUserBundle:Registration:confirmed.html.'.$this->getEngine(), array(
            'user' => $user,
        ));
    }
