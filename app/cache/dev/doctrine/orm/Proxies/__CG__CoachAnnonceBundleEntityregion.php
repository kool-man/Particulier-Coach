 ...
 */
class region extends \Coach\AnnonceBundle\Entity\region implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Coach\\AnnonceBundle\\Entity\\region' . "\0" . 'id', '' . "\0" . 'Coach\\AnnonceBundle\\Entity\\region' . "\0" . 'name', '' . "\0" . 'Coach\\AnnonceBundle\\Entity\\region' . "\0" . 'departement');
        }
