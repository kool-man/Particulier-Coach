 ...
 */
class Menu extends \Coach\PageBundle\Entity\Menu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Coach\\PageBundle\\Entity\\Menu' . "\0" . 'id', '' . "\0" . 'Coach\\PageBundle\\Entity\\Menu' . "\0" . 'createdAt', '' . "\0" . 'Coach\\PageBundle\\Entity\\Menu' . "\0" . 'updatedAt', '' . "\0" . 'Coach\\PageBundle\\Entity\\Menu' . "\0" . 'parentId', '' . "\0" . 'Coach\\PageBundle\\Entity\\Menu' . "\0" . 'titre', '' . "\0" . 'Coach\\PageBundle\\Entity\\Menu' . "\0" . 'lien', '' . "\0" . 'Coach\\PageBundle\\Entity\\Menu' . "\0" . 'enabled');
        }
